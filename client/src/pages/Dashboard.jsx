  ...
  return (
    <div className="page dashboard">
      ...
      <div className="dashboard-header">
        <div>
          <h1>
            Good {greeting()}, {profile?.username || "Learner"}
          </h1>
      ...
      <div className="stats-row">
        <StatCard icon={<img src={streakIcon} alt="streak" width={28} height={28} />} label="Day Streak" value={profile?.streak || 0} suffix="days" />
        <StatCard icon={<img src={expIcon} alt="xp" width={28} height={28} />} label="Total XP" value={profile?.xp || 0} />
        <StatCard icon={<img src={sessionIcon} alt="sessions" width={28} height={28} />} label="Sessions" value={profile?.total_sessions || 0} />
        ...
        <div className="modules-grid">
          {modules.map((mod) => (
            <ModuleCard
              key={mod.id}
              module={mod}
              onStudy={() => navigate(`/modules/${mod.id}`)}
            />
          ))}
        </div>
      )}
  ...
  return (
    <div className="session-row">
      <span
        ...
        style={{
          borderLeft: `3px solid ${modeColors[session.mode] || "var(--border)"}`,
          paddingLeft: "0.5rem",
        }}
      >
        {session.mode}
