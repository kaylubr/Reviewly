...
export async function generateFlashcards(content, fileUrl = null) {
...
export async function generateMCQ(content, fileUrl = null, count = 10) {
  const client = getAdminClient()
...
export async function summarizeContent(content, fileUrl = null) {
  const client = getAdminClient()
