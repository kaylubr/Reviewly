    ...
    <div className="landing">
      <nav className="landing-nav">
        ...
        <div className="landing-nav-links">
          ...
          <a href="#team">Team</a>
          <button className="btn-signin" onClick={() => router.push('/auth?mode=signin')}>Sign In</button>
          <button className="btn-login" onClick={() => router.push('/auth')}>Login</button>
        </div>
      </nav>
      ...
      <section className="hero">
        <motion.div className="hero-content" initial={{ opacity: 0, y: 32 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <div className="hero-cta">
            <motion.button className="hero-cta-button" whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }} onClick={() => router.push('/auth')}>
              Start an exam
            </motion.button>
          </div>
        </motion.div>
      ...
      <section className="features-section" id="features">
        ...
        <div className="features-grid">
          <motion.div className="feat-card feat-white" initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0 }} viewport={{ once: true }}>
            ...
            <button className="feat-learn" onClick={() => router.push('/auth')}><img src="/assets/learn-more-icon.png" alt="" /> Learn more</button>
          </motion.div>
          ...
          <motion.div className="feat-card feat-dark" initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.16 }} viewport={{ once: true }}>
            ...
            <button className="feat-learn feat-learn-white" onClick={() => router.push('/auth')}><img src="/assets/learn-more-white-icon.png" alt="" /> Learn more</button>
          </motion.div>
